...
public:
   ...
   Unit(Map* map, uint32 id, std::string model, Stats* stats, uint32 collisionRadius = 40, float x = 0, float y = 0, AI* ai = 0) : Object(map, id, model, x, y, collisionRadius), stats(stats), ai(ai),
